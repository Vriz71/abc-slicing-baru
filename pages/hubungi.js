    ...
    return (
        <div>
            ...
            <section className='container columns-1 mx-10 md:grid md:grid-cols-2 md:mx-16 lg:grid lg:grid-cols-2 lg:px-28 lg:mx-0 py-24 md:py-32'>
                {/* IMG Mobile */}
                <img src='Hubungi Kami.svg' className='-ml-6 pb-16 md:hidden'/>
                <div className='lg:w-96'>
                    <p className='font-display font-normal text-sxs text-main-color'>CONTACT US</p>
                    <p className='font-display font-normal text-3xl py-2'>Apakah <span className='font-extra-bold'>kamu siap?</span></p>
                    <p className='font-display text-md'>Kami selalu siap untuk menjawab segala pertanyaan dan kebutuhan kamu</p>

                    <form className='pt-10 font-display'>
                ...
                {/* IMG MD and LG */}
                <img src='/Hubungi Kami.svg' className='hidden md:block lg:ml-10 lg:mt-0 mt-10'/>
            </section>
        </div>
    )
}
